...
def load_data():
    path = "C:\\Users\\SulaimanAbdulRazzaqY\\Desktop\\Projects\\Excel Manger\\people.xlsx"
...
def insert_row():
    ...
    status_combobox22 = status_combobox2.get()
    employment_status = "Subscribed" if a.get() else "UnSubscribed"
    ...
    if name == "" :
        ...
        print(name, age,employment_status,status_combobox22 )
        path = "C:\\Users\\SulaimanAbdulRazzaqY\\Desktop\\Projects\\Excel Manger\\people.xlsx"
        workbook = openpyxl.load_workbook(path)
        sheet = workbook.active
        row_values = [name, age,employment_status,status_combobox22]
        ...
        status_combobox2.set(combo_list2[0])
...
combo_list2 = ["Employed", "UnEmployed", "College","School"]
...
status_combobox2.grid(row=3, column=0, padx=5, pady=5,  sticky="ew")

a = tk.BooleanVar()
checkbutton = ttk.Checkbutton(widgets_frame, text="Subscribed", variable=a)
checkbutton.grid(row=5, column=0, padx=5, pady=5, sticky="nsew")
...
treeview.column("Subscription", width=150)
